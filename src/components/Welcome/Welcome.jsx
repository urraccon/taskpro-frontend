  ...
  return (
    <WelcomeContent>
      <picture className='WelcomeContent__img'>
        <source srcSet={`${logoDeskAndTab}, ${logoDeskAndTabRetina}`} media='(min-width: 1440px)' />
        <source srcSet={`${logoDeskAndTab} , ${logoDeskAndTabRetina}`} media='(min-width: 768px)' />
        <source srcSet={`${logoMobile} , ${logoMobileRetina}`} media='(max-width: 767px)' />
